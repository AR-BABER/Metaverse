...
let places: string[]=["canada","Australia","america","zimbabwa","india","afganaistan"];
console.log(places)
        
let sortP: string[]=places.slice().sort(function(a, b) {
    if (a < b) {
      return -1;
    } else if (a > b) {
      return 1;
    ...
    for(let i:number=sortP.length; i>=0;  i--)
    {
